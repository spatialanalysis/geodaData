...
#'
#' Incidents of drugs/narcotics possession or sale for July 1 to December 31, 2012.
#'
#' Sf object, EPSG 2227: NAD83 / California zone 3 (ftUS).
#'
#' @format sf data frame with 3897 observations, 14 variables, and a geometry column.
#' \describe{
