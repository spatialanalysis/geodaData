...
#'
#' @format List of four sf data frames. Use \code{list2env(SFcrime)} to unlist in working environment. \strong{Cartheft:} sf data frame with 607 observations, 18 variables, and a geometry column. \strong{Drugs:} sf data frame with 3,897 observations, 13 variables, and a geometry column. \strong{Robberies:} sf data frame with 2,761 observations, 13 variables, and a geometry column. \strong{Vandalism:} sf data frame with 3,430 observations, 13 variables, and a geometry column
#' \describe{
