...
#'
#' @format List of two sf dataframes. Use \code{list2env(kchomesale, .GlobalEnv)} to unlist in working environment. \strong{kchomesales_points} includes homesales points with with 21613 rows, 21 variables, and a geometry column and \strong{kc_zones} includes polygons of zones for King County (85 rows, 7 variables and a geometry column).
#' \describe{
#'	\item{	date	}{	date sold	}
...
#'	}
#' @source  King County Home sales obtained from \url{https://www.kaggle.com/harlfoxem/housesalesprediction/discussion} and King county polygons from \url{https://gis-kingcounty.opendata.arcgis.com/datasets/zipcodes-for-king-county-and-surrounding-area-shorelines-zipcode-shore-area}
#'
#' @examples
