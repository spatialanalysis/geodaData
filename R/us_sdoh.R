...
#'	\item{	rntov30p_1	}{	Percentage of renters paying over 30% of income towards housing estimate, 2010-2014 ACS	}
...
#'	\item{	SDOH_CL	}{	1= rural affordable, 2=suburban affluent, 3=suburban affordable, 4=extreme poverty, 5=multilingual working, 6=urban core opportunity, 7=sparse areas (see https://sdohatlas.github.io/)	}
#' }
