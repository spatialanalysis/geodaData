#' NYC Neighborhood (2008-12)
#'
#' Demographic information for New York City aggregated to neighborhood tabulation area (NTA).
#'
#' Sf object, unprojected. EPSG 4326: WGS84.
#'
#' @format An sf data frame with 195 rows, 97 variables, and a geometry column:
#' \describe{
...
#'	\item{	ntaname	}{	New York City Neighborhood Tabulation Area (NTA) name	}
#'	\item{	boroname	}{	name of the NYC borough	}
#'	\item{	popdty	}{	Population Density (per sq. mile)	}
#'	\item{	ntacode	}{	code associatd with the Neighborhood Tabulation Area (NTA)	}
...
#'   library(sf)
#'   data(nycneighborhood)
#'
#'   plot(nycneighborhood["gini"])
#' }
"nycneighborhood"
