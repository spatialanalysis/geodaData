...
#'
#' @format An sf data frame with 506 rows, 24 variables, and a geometry column:
#' \describe{
...
#'	\item{	X	}{	X Coordinates (UTM Zone 19)	}
#'	\item{	Y	}{	Y Coordinates (UTM Zone 19)	}
