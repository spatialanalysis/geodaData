...
#'
#' @format An sf data frame with 209 rows, 22 variables, and a geometry column:
#' \describe{
...
#'	\item{	AL99CIRC	}{	Percent of Alianza Votes over Valid Votes	}
#'	\item{	APR99CIR	}{	Percent of APR Votes over Valid Votes	}
#'	\item{	TURN99CR	}{	Percent of Effective Votes over Valid Votes	}
#'	\item{	EAST	}{	East Coordinates	}
#'	\item{	NORTH	}{	North Coordinates	}
#'	\item{	NDRANO	}{	Numeric ID (for use in GeoDa)	}
#'	\item{	APR99PC	}{	Percent of APR Votes over Valid Votes	}
#'	\item{	AL99PC	}{	Percent of Alianza Votes over Valid Votes 	}
#'	\item{	TURN99PC	}{	Percent of Effective Votes over Valid Votes}
#' }
