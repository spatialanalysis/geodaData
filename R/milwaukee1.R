...
#'
#' @format An sf data frame with 417 rows, 31 variables, and a geometry column:
#' \describe{
#'	\item{	FIPS	}{	FIPS Code	}
#'	\item{	MSA	}{	MSA Name	}
...
#'	\item{	PCTBLCK	}{	Percentage of black population	}
