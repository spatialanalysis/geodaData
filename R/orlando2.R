...
#'
#' Business data for the Orlando-Kissimmee Metropolitan Statistical Area, Florida (1998 and 2001).
#'
#' Sf object, unprojected. EPSG 4326: WGS84.
#'
#' @format An sf data frame with 94 rows, 55 variables, and a geometry column:
#' \describe{
#'	\item{	ZIP	}{	ZIP code	}
